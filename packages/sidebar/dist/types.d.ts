 ...
 */
export declare function isPage(item: SidebarRootItem): item is SidebarPage;
/**
 * Type guard for SidebarGroup
 */
export declare function isGroup(item: SidebarRootItem): item is SidebarGroup;
/**
 * Type guard for SidebarSection
 */
export declare function isSection(item: SidebarRootItem): item is SidebarSection;
/**
 ...
 */
export declare const defaultSchema: SidebarSchema<SidebarItem | SidebarSection>;
/**
